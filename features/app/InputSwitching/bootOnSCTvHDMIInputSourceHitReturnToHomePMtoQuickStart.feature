...
#  @e2e @smoke
# Feature:Smoke test
#  BootOnSCTV on top of inactive HDMI Input Source & hit 'Return to Home' option during timer display while 'Input at Power On' is set to 'VIZIO Home'&'Power Mode' is set to Quick Start

#   Scenario:boot On SCTv HDMI Input Source Hit Return To Home PM To Quick Start
