...
#   DC Power OFF/ON on top of native apps with 'Input at Power On' set as 'Vizio Home' & 'Power Mode' set as 'Quick Start'

#   # Pre-Conditions
#   Background:
#     Given Set "Input at Power On" as "Vizio Home" and Set "Power Mode" as "Quick Start" under system from settings

#   Scenario: Perform DC Power OFF/ON on Netflix and YouTube App with 'Input at Power On' set as 'Vizio Home' & 'Power Mode' set as 'Quick Start'
