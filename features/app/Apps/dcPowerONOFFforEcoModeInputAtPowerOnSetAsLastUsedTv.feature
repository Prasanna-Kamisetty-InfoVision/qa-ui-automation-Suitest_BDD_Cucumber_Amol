...
#   DC Power OFF/ON on top of native apps with 'Input at Power On' set as 'Last Used TV Input' & 'Power Mode' set as 'Eco Mode'

#   # Pre-Conditions 
#   Background:
#     Given Set "Input at Power On" as "Last Used TV Input" and Set "Power Mode" as "Eco Mode" under system from settings

#   Scenario: Perform DC Power OFF/ON on Netflix and YouTube App with 'Input at Power On' set as 'Last Used TV Input' & 'Power Mode' set as 'Eco Mode'
...
#     # Dc Power ON 
#     When I perform DC Power ON on the Tv
#     # After Dc Power ON verify vizio home page
