...
class HomePage {
    ...
    static async verifyHomePageOpened() {
        ...
        const trendingNowTitle = helpers.UiElementSelectorBuilder.onScreenItemElementsimpleByText("Trending Now");
...
static async playContentOnDisney() {
    try {
       ...
       console.log("Played content for 30 second...!!! ");
        ...
        console.log("Test failed : Unable to play content on DisneyApp app...!!!");
